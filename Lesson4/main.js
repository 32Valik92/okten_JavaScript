...
console.log(`Площа прямокутника = ${squareRectangle(2, 10)}`);
console.log('');
...
console.log(`Площа кола = ${squareRound(2)}`);
console.log('');

// ---------------------------------------------------------------------------------------------------------------------

// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіусом r
function volumeCylinder(height, radius) {
    return squareRound(radius) * height;
}

console.log(`Об'єм циліндра = ${volumeCylinder(10, 2)}`);
console.log('');
...
function showFourthArray(array) {
...
function ulCountLi(textLi, count) {
    document.write(`<ul>`);
